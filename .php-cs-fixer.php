...
$finder = PhpCsFixer\Finder::create() # inteliphense might return an error, its normal ;)
    ->in($path . 'app/Http')
    ->in($path . 'app/Models')
    ->in($path . 'database')
    ->in($path . 'resources')
...
$config = new PhpCsFixer\Config(); # inteliphense might return an error, its normal ;)
return $config
